function affichername() { 		//cette partie de la fonction sert à récupérer le nom entré par l'utilisateur et l'écrire ensuite dans le html
	...
	var themeTetris = new Audio("Tetris Theme.mp3");		//la musique démarre une fois que le nom est inscrit et que le jeu apparait
	themeTetris.play();
...
//prédéfinition par avance des variables
var ROWS = 20; // prédéfinition nombre de colonnes et de lignes pour la grille
var COLS = 10;
var SIZE = 32;
...
var fonctionBonus = function () { //fonction bonus, à l'appui de la touche elle génére une nvlle pièce et la dessine dans le canvas
...
document.body.addEventListener("touchmove", function (e) //l'effet de gravité, la pièce est intégrée au coordonnées X du canvas, et le Y va être incrémenté pour que la piéce descende
{
	e.preventDefault();
